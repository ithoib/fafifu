                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header py-3">
                            <div class="row">
                                <h6 class="m-0 font-weight-bold text-primary">Simple FaFiFu Generator</h6>
                        ...
                        <div class="card-body">
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="constant1" class="form-control" placeholder="Masukkan isian constant1" rows="5"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>[constant2]</label>
                                    <textarea name="constant2" class="form-control" placeholder="Masukkan isian constant2" rows="5"></textarea>
                                </div>
                                <div class="form-group">
                            ...
                            if(isset($_POST['generate'])){
                                ...
                                if(!empty($dataArr)){
                                    ...
                                    $txt = str_ireplace(array('[constant1]','[constant2]'),array($constant1,$constant2),$txt);
